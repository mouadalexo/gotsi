...
module.exports = {
  ...
  async execute(interaction, client) {
    try {
      // Let handlers acknowledge component interactions normally. Discord reports
      // genuinely expired component tokens as error 10062, which is handled below.
      // A short local cutoff caused valid buttons on older ephemeral panels to fail.
